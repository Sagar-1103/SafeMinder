...
const AppNavigation = () => {
    ...
    const {role,setRole,loggedIn,process, setRadius,setProcess,setCaretaker,setContacts,setUser,setLoggedIn,isAssigned,setIsAssigned,code,setCode,setUserHomeLocation} = useLogin();
